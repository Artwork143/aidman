...
<body>
    <div class="message-box">
        ...
        if (isset($_GET['status']) && $_GET['status'] == 'success') {
            ...
            echo '<h1 class="success">Registration Complete</h1>';
            echo '<p>Your registration was successful! You will be redirected to the login page shortly. Enjoy exploring our features!</p>';
        } else {
            echo '<div class="icon">❌</div>';
            ...
            $redirect_url = "reg-forum.php?duplicate=$duplicate&fullname=" . urlencode($name) . "&email=" . urlencode($email) . "&username=" . urlencode($username);
